...
wget --post-data "username=$username&password=$password" 'https://download.is.tue.mpg.de/download.php?domain=smplx&sfile=SMPLX_NEUTRAL_2020.npz&resume=1' -O './deformer/dataset/SMPLX_NEUTRAL_2020.npz' --no-check-certificate --continue

# scarf utilities
echo -e "\nDownloading data..."
wget https://owncloud.tuebingen.mpg.de/index.php/s/n58Fzbzz7Ei9x2W/download -O ./deformer/dataset/scarf_utilities.zip
unzip ./deformer/dataset/scarf_utilities.zip -d ./deformer/dataset
rm ./deformer/dataset/scarf_utilities.zip
